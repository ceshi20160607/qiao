...
class JsonConvert {
  static final Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (CarEntity).toString(): CarEntity.fromJson,
    (LoginEntity).toString(): LoginEntity.fromJson,
    (SaTokenEntity).toString(): SaTokenEntity.fromJson,
  };
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<PagingParams>[] is M) {
      return data
          .map<PagingParams>(
              (Map<String, dynamic> e) => PagingParams.fromJson(e))
          .toList() as M;
    }
    if (<CarEntity>[] is M) {
      return data
          .map<CarEntity>((Map<String, dynamic> e) => CarEntity.fromJson(e))
          .toList() as M;
    }
    if (<LoginEntity>[] is M) {
      return data
    ...
    if (<SaTokenEntity>[] is M) {
      return data
          .map<SaTokenEntity>(
              (Map<String, dynamic> e) => SaTokenEntity.fromJson(e))
          .toList() as M;
    }
