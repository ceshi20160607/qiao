...
SaTokenEntity $SaTokenEntityFromJson(Map<String, dynamic> json) {
	...
	final int? tokenSessionTimeout = jsonConvert.convert<int>(json['tokenSessionTimeout']);
	if (tokenSessionTimeout != null) {
		saTokenEntity.tokenSessionTimeout = tokenSessionTimeout;
	}
	final int? tokenActivityTimeout = jsonConvert.convert<int>(json['tokenActivityTimeout']);
